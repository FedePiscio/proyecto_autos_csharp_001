...
namespace ProyectForms.ClaseEspace
{
    /// <summary>
    /// CLASE FALCON 9
    /// Definimos los atributos y metodos relacionados a la clase FALCON 9.
    /// La misma hereda la clase abstracta EspaceAbstract, sus atributos y sus metodos.
    /// </summary>
    public class EspaceFalcon9 : EspaceAbstract
    {
        ...
        /// </summary>
        public EspaceFalcon9(int nId, int anio, int hsActual, string color, string empresa) : base(nId, anio, hsActual, color, empresa)
        {
            this.autonomia = 200;
            this.service = 400;
            this.modelo = "EspaceX - Falcon 9";
        ...
        public void recorrido(int kmRecorrer)
        {
            ...
            else
            {
                if (kmRecorrer > this.autonomia)
                {
                    ...
                    double consumoDouble = ((double)kmRecorrer / 200) * 100;
