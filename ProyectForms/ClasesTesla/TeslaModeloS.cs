...
namespace Proyecto.ClasesTesla
{
    ...
    /// </summary>
    public class TeslaModeloS: TeslaAbstract
    {
        ...
        /// </summary>
        public TeslaModeloS(int nId, int anio, int kmActual, string color, string duenio):base(nId, anio, kmActual, color, duenio)
        {
            this.autonomia = 650;
            this.asientos = 5;
            this.service = 2000;
            this.modelo = "Tesla - Modelo S";
        ...
        public void conducir(int kmRecorrer)
        {
            ...
            else
            {
                if (kmRecorrer > this.autonomia)
                {
                    ...
                    double consumoDouble = ((double)kmRecorrer / 650) * 100;
