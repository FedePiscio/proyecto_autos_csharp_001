...
namespace Proyecto.ClasesTesla
{
    ...
    /// </summary>
    public class TeslaModeloX : TeslaAbstract
    {
        ...
        /// </summary>
        public TeslaModeloX(int nId, int anio, int kmActual, string color, string duenio) : base(nId, anio, kmActual, color, duenio)
        {
            this.autonomia = 560;
            this.asientos = 7;
            this.service = 1000;
        ...
        public void conducir(int kmRecorrer)
        {
            ...
            else
            {
                if (kmRecorrer > this.autonomia)
                {
                    ...
                    double consumoDouble = ((double)kmRecorrer / 560) * 100;
